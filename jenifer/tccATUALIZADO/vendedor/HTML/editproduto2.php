...
if ($linha = mysqli_fetch_array($resultadop))
{
    
   
    $nomeP = $linha['nome_produto'];
    $valorP = $linha['valor_produto'];
    $descricaoP = $linha['descricao_produto'];
...
<body style="max-height:650px">
   ...
   <div class="formulario-ender3" style="height:650px">
   
   
   <div class="container" style="margin-top:30px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
   
          <div class="container-principal-produtos" style="width:1080px;margin-left:50px;">
           <h4 class="page-header">Editar Produto</h4>
           <hr>
              <form <?php echo "action='editor.php?idp=$idP'"; ?> method="POST" enctype="multipart/form-data" name="upload" style="position:static;">
                <div class="row">
                  <div class="form-group col-md-4">
                    <label>Descrição do Produto:</label>
                    <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="descricao_produto" value="<?php echo $nomeP; ?>" placeholder="Digite o nome do produto" required/ >
                  </div>
                  <div class="form-group col-md-4">
                    <label>Valor do Produto:</label>
                    <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="valor_produto" value="<?php echo $valorP; ?>"  placeholder="Digite o valor do produto" required/>
                  </div>
                  <div class="form-group col-md-4">
                    <label>Porcentagem do Produto:</label>
                    <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="porcentagem_desconto_produto" value="<?php echo $desconto; ?>" placeholder="Digite oa porcentagem do produto" />
                  </div>
                  ...
                  <div class="row">
                    ...
                    <label class="picture2"  for="picture__input2" tabIndex="0">
                      <!--  <span class="picture__image"></span> -->
                        ...
                        <?php echo '<img id="minhaImagem2" src="../../imagens/'.$imgP.'" class="picture__image2" />'  ?>
                      </label>

                      <input type="hidden" value="<?php echo $imgP; ?>" name="picture__input2_oculto" id="picture__input2_oculto"/>
    
                      <input type="file" value="<?php echo $imgP; ?>" name="picture__input2" id="picture__input2">
          </label>
                ...
                <div class="row">
                  <div class="form-group col-md-8">
                    <label>Descrição do Produto:</label>
                    <textarea cols="4" rows="2" class="form-control col-md-8" name="descricao_detalhada_produto"    placeholder="Digite alguma descrição sobre o produto"><?php echo $descricaoP; ?></textarea>
                  </div>
                </div>
