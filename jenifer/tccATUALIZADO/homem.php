...
<body>
  ...
  <header>
    ...
    include("conexao.php");
                            ...
                            $sql = "SELECT * FROM tabela_produto where tipo_produto = 1 ORDER BY cod_produto DESC";
        ...
        <ul class="footer-nav-list">
          ...
          <address class="content">
                                  Priorizamos a segurança e eficiência<br>
                                               ...
                                               em parceria com os Correios, <br>
                                              garantindo cuidado e pontualidade.<br>
                                              Do pedido à sua porta, <br>
                                              mantemos você informado sobre o status da remessa.<br>
                              </addres>
