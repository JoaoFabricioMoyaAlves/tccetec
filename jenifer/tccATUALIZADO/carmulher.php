  ...
  <header>
    ...
    <div class="header-main">
      ...
      <a href="home.php" class="header-logo">
        ...
        <form action="mulherpesquisa.php" class="header-search-container" method="post">
        ...
        <?php 
          ...
          <a href="cliente/HTML/carrinho.php" style="color: black;">
    ...
    <div class="banner" style="margin-left:80px;">
            ...
            <img src="./assets/images/banner_mulher.jpg" alt="women's latest fashion sale" class="banner-img" style="padding-bottom:60px;border-bottom:1px solid var(--cultured)">
    </div>
    ...
    include("conexao.php");
                            ...
                            if($catgo == 'Acessorios'){
                                ...
                                $sql = "SELECT * FROM tabela_produto WHERE   categoria_produto in ('Boné','Cinto','Óculos','Relógio', 'Anel', 'Bolsa','Brinco', 'Colar','Pulseira')  AND tipo_produto = '2' ; ";
                              //pegando os dados da tabela. Executando query
                              $resultado = mysqli_query($conexao, $sql);
                                   
                              }else{
                              $sql = "SELECT * FROM tabela_produto WHERE   categoria_produto = '$catgo' AND tipo_produto = '2' ";
                              //pegando os dados da tabela. Executando query
                              $resultado = mysqli_query($conexao, $sql);
                              //fazendo a seleção da tabela tb_evento
                              }
